describe('Login Page', () => {
    ...
    /**
     * TESTS RELATED TO GENERAL INPUT VALIDATION, INCLUDING EMAIL FORMATTING, EMPTY STATES AND PARTIAL ATTEMPTS.
     */

    context('When testing general input validation', ()=> {
    ...
    /**
     * TESTS RELATED TO AUTHENTICATION: SUCCESSFUL AND UNSUCCESFUL LOGIN ATTEMPTS.
     */

    context('When testing authentication flows', () => {
    ...
    /**
     * TESTS RELATED TO BASIC SECURITY VALIDATIONS, AUTHENTICATION MECHANISMS AND COMMON INJECTIONS.
     */

    context('When testing general security', () => {
        ...
        it('should not be able to access the dashboard without being logged in', () => {
            ...
            Same issue discussed in the following test (AUTH ERROR WHEN ATTEMPTING TO RETURN...), but more interesting. It is possible to go directly to the dashboard
    ...
    /**
     * TESTS RELATED TO SESSION PERSISTENCE, BROWSER NAVIGATION AND STATE HANDLING.
     */

    context('When testing session management', () => {
    ...
    /**
     * TESTS RELATED TO PASSWORD RECOVERY OPTION AND ITS FLOWS (OR LACK THEREOF).
     */

    context('When testing password recovery option', () => {
